...
from knowledge_extraction_flow.tools import FileConversionTool, FileUploadTool
...
class DocConversionCrew:
    ...
    def upload_file_to_google_task(self) -> Task:
        return Task(
            ...
            output_file="output/01_upload_file_to_google_report.md"
        )
    ...
    def format_document_to_markdown_task(self) -> Task:
        return Task(
            ...
            output_file="output/02_format_document_to_markdown_report.md"
        )
